...
function changeBg(status) {
    if (status === 'Clouds') {
        document.body.style.backgroundImage = 'url(intern and  pep tasks/clouds.jpg)';
    } else if (status === 'Rain') {
        document.body.style.backgroundImage = 'url(intern and  pep tasks/rainy.jpg)';
    } else if (status === 'Clear') {
        document.body.style.backgroundImage = 'url(intern and  pep tasks/clear.jpg)';
    }
    else if (status === 'Snow') {
        document.body.style.backgroundImage = 'url(intern and  pep tasks/snow.jpg)';
    }
    else if (status === 'Sunny') {
        document.body.style.backgroundImage = 'url(intern and  pep tasks/sunny.jpg)';
    } else if (status === 'Thunderstorm') {
        document.body.style.backgroundImage = 'url(intern and  pep tasks/thunder.jpg)';
    } else if (status === 'Drizzle') {
        document.body.style.backgroundImage = 'url(intern and  pep tasks/drizzle.jpg)';
    } else if (status === 'Mist' || status === 'Haze' || status === 'Fog') {
        document.body.style.backgroundImage = 'url(intern and  pep tasks/mist.jpg)';
    }

    else {
        document.body.style.backgroundImage = 'url(intern and  pep tasks/bg.jpg)';
    }
}
